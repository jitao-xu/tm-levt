...
class LevenshteinTransformerModel(FairseqNATModel):
    ...
    def __init__(self, args, encoder, decoder):
        ...
        self.predict_prev_del = args.prediction_for_prev_deletion
    ...
    def forward(
        ...
        if self.prev_del:
            ...
            prev_output_tokens, _, _ = _apply_del_words(
                ...
                prev_word_del_out.max(-1)[1].bool() if self.predict_prev_del 
...
def levenshtein_base_architecture(args):
    ...
    args.prediction_for_prev_deletion = getattr(
        args, "prediction_for_prev_deletion", False
    )
